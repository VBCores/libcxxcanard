...
#
# Source file:
# /home/pi/control/external/public_regulated_data_types/uavcan/si/unit/luminance/Scalar.1.0.dsdl
#
# Generated at:  2024-06-20 11:16:14.362399 UTC
# Is deprecated: no
# Fixed port ID: None
...
class Scalar_1_0:
    ...
    _MODEL_: _pydsdl_.StructureType = _restore_constant_(
        'ABzY8eh+kJ0{?YWO-~d-5FO-GPziw;6Ay4gyo~x6G}+4tZp3&qoto)lr<0!Pu|GDuCM0r@i0MQV%HQcvSgToJ5kp_5daC+$y;rZl'
        'F8uy8pIxlD-HoM_Iu{PD0<FG4sWBIoX*%PSM~V**y$zKQ7C($Tq;q<HLdUch7exyV=eGk4D`<14^3W=u>(Hnc+6wc-3N%=XD`JS&'
        'DbrG&#pREe@i`T9MRrOj6xRfJZ&evQI{HL+HFaG?aj~aR%ULt4LV^e3Q-^mQ@2qN+S3|D2-_r*CzkJq2sl3qG4t!0;4ntPpyl9L>'
        's<-0f{?+kxEPunf{gh%F**AJmaZ5N4tpqD?0)1zk1_mrlkm=$h3zcX3j%Ddx#*Fb}BfGgKlSx+0oic1F>&5tl^_8eWbZCY99KfPz'
        '&?9TRAf%}%W?Tqy^M;P198U*yO!aQP;h3Mq&SC`~C7s1b;z*59iq2Rsl%#{WA)E=eLQZHD9dP$?IeoM$x${2zVbo85&snXx7kqbZ'
        'k^$~@iVG{#dTTV(!V!1Y0*6n#P-;~Pi-Vxky|XDX|D~yM7{D>WLNX6ub8R1r>r(^eukx398Yuas^QNf5aeEe9pC&w1TzghOtM^!p'
        'QZw-G)%<63;6i_UPw~NP<=<ZH4|#j(gg7ruM{(ya5I1g0!>qWIeQXT7E6wm7j|RN4Ge0efs#fgLx);~`Af;*t{}t6m${qyGG{?8I'
        'j4%Wpkbcr$vGdE7{E)gS5EUz-WV$R>vML8KO2KlnD@&bDuL>M>&|bW?gHXCMl=)u=EFhTr0{{R'
    )
