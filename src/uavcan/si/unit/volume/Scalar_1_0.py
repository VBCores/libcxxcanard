...
#
# Source file:
# /home/pi/ws/types/public_regulated_data_types/uavcan/si/unit/volume/Scalar.1.0.dsdl
#
# Generated at:  2025-12-19 12:32:01.156057 UTC
# Is deprecated: no
# Fixed port ID: None
...
class Scalar_1_0:
    ...
    _MODEL_: _pydsdl_.StructureType = _restore_constant_(
        'ABzY8!9_)B0{?|m&rcLF6drUJ5L6@(J!m2)TrUIo^Q<OZR&XQg%{1+_Y@2kZlm1wDO-SS*5z|Byo_{aC&Mq!uh&{}-{rbMX@4c^I'
        'TEAYjvS!5l^@uyJbK-<mRIAUFX_1q{l(lin3y3%NybXm9R=gY40#4xJAsj#_wn;@x#P0<<C}@>Cm4{0Cd|-4aMZQ;1O)bQEG7#1&'
        'Q-RFl+=t2h1iCZb><A7aE)wd!RV;Yn;3Hg?(Vs&Q+uKTLKFwr-aOx@XDZR_WYpY7-)c{Xi+t!Bqzr`#PraaN2>U#;@HKZ)4^Q1If'
        'fLx8YduQP(EPsXAPJ&QI_7&bjTqVxaic`za6MaLTlJ>DGfv1c2EiF9CcUYF~$s9SpFK6e+>FH_KojF3<z+^iv7J;dPl)?)vXNz!C'
        'K+F)Maphd;2pf$XasYB&E<2ROMQuevz2I;hZ<2jA6r9w?dZIY&#%1D6u!TTC3sO@|IL@V?Rt%HvVgHA{w0nXDn%Tg+rAZCHQY-v?'
        'LJ{p$a{S+|1JjtJ75$*oeba^@Iy*K9#yAXYC6nOh*d`E{#zx7v^36Oo4t%QT3X#-dPF7Stb#kBz0mt%z?8IA*%&|i&gp+AH|G8v#'
        ';zkkgG(w3t#2VupDpyk^mzy2AB_GMh@`-#ZpULM<9xcK&N?1QL)wH>omA|-#c>SgFubcHAE+_ViSBa@1u3bjrMkO;?Ka{;AN`sb7'
        '#&}Z;OTDpElg^StDm1?A#ibtQTvh#l4$1ck-3=P$jxM6eFrYdJ_yL{n+E2&ub=G4d=*|a*a!XYu|Ko%X(_}8a0c>iDULayv)2eyE'
        'yMZ|tSpFLq8X*l#1ONa'
    )
