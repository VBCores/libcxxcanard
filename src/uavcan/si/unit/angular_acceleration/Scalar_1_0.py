...
#
# Source file:
# /home/pi/ws/types/public_regulated_data_types/uavcan/si/unit/angular_acceleration/Scalar.1.0.dsdl
#
# Generated at:  2025-12-19 12:32:01.141805 UTC
# Is deprecated: no
# Fixed port ID: None
...
class Scalar_1_0:
    ...
    _MODEL_: _pydsdl_.StructureType = _restore_constant_(
        'ABzY8!9_)B0{@j$OK%e~5KbX|&;q4u1qYDmsRRy7%kvIWFQFx(zztcmwuvq6u2+791W}0|s3@`oQitDL#z{&-p$B}}9eX^F@AEgG'
        'n?FA_8^aZE*8|~1kufK&hC+XYypS2=rmT(AUShnm=WXCVSowNTOFYKA2e^-|ILj(1$$u|Ek3*F?orOyK461G@z%t-m7Se*(rpop>'
        '&>6-B)|1xJ393e%e>=91u|3mn9O41SB?jJGod+)+zQgnS`+W)H?6#JLnDn*C1bARRHG5uoZFQ-=?$M1)+l2xDC$uG&YtIT<b-lv&'
        'I;G^`JS&ZmsMg~3&S`iG%bt^OC%Fhl;|spRxW=4^N`Mv9iM~>v61v1u5UKEc3p|nIh?ecKO*y`;G^W?d$w{L<b4Y1Ju4dyc3qnK1'
        'YH0}*H<g$&F*cbn9AkqnLtLHWlI4TZd+npzP%Dlw3Rzpp!ApTh@hW?-`;w9w>zNj~8&{Y!!E#BCLb4hNL7Y#&Lg&<dhvd=kq|;+!'
        'Z00`IRwn7;LapiZfl$q+H=zH`I^>1s%*vz;syBHd^3IL)Lotp5n@K~&;J;Laae1VpY%AN$(z~Khbgwc6jyklm^68;_noB%VcT_80'
        '8-gCmxgvMcRO`P=&W)uj<BcH+%o}En@x#Qf1}ddCTWU)^P!H83^;kVoPlsJKSzZvljZ+0qlt4ZDvwMt}pK1SMxZk7gSc~x@Gd0Hb'
        '^OCqhnH%DkNZ663A$_N=U)HI8V<(E9V_a#P64i;z9S}lS-M=oWH_5vj3W7U0>!l1mD1yZA*lMr;a5;@~JxYY_g^&~6QdenM$bfz_'
        '=F`9sqbYik$$kyhaN2i6?(&dlzW^^VDd2|$000'
    )
