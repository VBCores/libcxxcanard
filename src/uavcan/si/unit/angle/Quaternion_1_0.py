...
#
# Source file:
# /home/pi/ws/types/public_regulated_data_types/uavcan/si/unit/angle/Quaternion.1.0.dsdl
#
# Generated at:  2025-12-19 12:32:01.151880 UTC
# Is deprecated: no
# Fixed port ID: None
...
class Quaternion_1_0:
    ...
    _MODEL_: _pydsdl_.StructureType = _restore_constant_(
        'ABzY8!9_)B0{?wfTW`}a6i!FGD+9(5Nbs;dq4Gc&0)co0M3Klg$_C>u%SpW2!igi>>6%HCwg)DLEHP>3=b~|(bhI0kNNt>)+jq`)'
        'zU<b2{;GTBWfrm`Rx$UHB9dXwwsFXbk0Oy|LNQIOnO)a1k901{>mnoe$lltsJGN;WD8&ib7joQ<aOx}O=PA=ZPCJm{RgN{0DHEwR'
        'lc-Cia!2Z!iH-jG$Og5*+qZkx%pk0_WMQs}vY+iJP=B1PX|x#O@c_&;im}E>JA~%Oh;S)!Va=5m>ydbwq#aEkyH}^%nni?@grvHk'
        'Yy_4}vV>{Y1&^r~7g(RpGJ`^<5ig6_U=i>|SZS1qm{@w<Ty39(yD<ML*jAhgX5xLdYXA}{jnf#*csS8F$dlj>OgWET;Z2Dn4YO1*'
        '<5vF+Ilj+%!`Jcgu@}_#A#EO-DFBk;i0Q%xbyG(nhv1thJq~I?yZY?2HRqo&T}^Hs9{b&zb4X;?ERIT|iX;@AMb^x(kVL=)9nO~-'
        'kyr~knAtdrC<9XIeRFw@WJI%n`;DP5fSo=9zl*Cm=U5hJogh~i^PJcpwizrQst`J_qlBe4*mVcobB77XN6s+>1U2XB9V(bG>18-A'
        'S9CQGT_|ms`c|*lwh$T%=);3aVlzLqwJ0nqIqX;(&^ZMQ5R*)j2viW;19Jgwx~)T*kQ%Yru9`WdL@px&22N0hfnGD=Zk&ZcZ5!0r'
        'YrD5c&~oh#)TYA8Z7gH(w*{;<+=42%?s*8~MUr%&8K^hV0$9f@c|weWz`Bztgq9)&LIyJR@A^x=BhYHMfb)oA1+b)30<3<QMZ_M^'
        'Wx8T6m7P|fh!o6Dvd#b3nI8Ha5Ob|;7ioc{5W38!U?)KtZ<=(2zNPQzd-{QXq@NrVdYdklq|$rzLA3%E_iY@<EbaWYAYgq6-<+&6'
        '+h7tHd=~7|7W|$=niqXq{og%N%0vhS000'
    )
