...
#
# Source file:
# /home/pi/ws/types/public_regulated_data_types/uavcan/si/unit/acceleration/Vector3.1.0.dsdl
#
# Generated at:  2025-12-19 12:32:01.100507 UTC
# Is deprecated: no
# Fixed port ID: None
...
class Vector3_1_0:
    ...
    _MODEL_: _pydsdl_.StructureType = _restore_constant_(
        'ABzY8!9_)B0{@Lv-D?v;5WloZ(^{*o6$SfXK#=(0S*a*Ksu;m*YiPB8v)#MfW*6^nkKMhP2nG9Kv9e&H<KJ6nlhmZufCtIV?R@@b'
        '=C@zVziJh)_t@)sH`a0D6U~&MiTFapg!v?rX)d)e4D8&dQAK15#a?!E21jsf4|bt$D<q>S>TeXZ9ns9!!Y?vmd>Tb8VTu|dGk=Rk'
        'MyeIC)1=Lm#v|aKt!@qEBM3@?w-0+@X9+b%iLfwC!$%lb*dHUXm4;wRJS^xOiK(H)xGL?^7<Z*;7wqMR=&*Q|Wi7)Wxuet2<_IE4'
        'S!M>o#?+E4kqRT)Xfe}BBsHg_%#u(TlJt^5P{aBnstrkH%z$6BSDGj8&dq;<x;3Z5o_OD21B)cu&@84Z9u4#z<D|5Ooi1XRct_F5'
        'wOV738v_|*{8;ctpX1|WFDUI}*dnwuSV&GIVY(1Z+A;|fbiR3lahMC?nzP?v&p#HX-?>fv9H6z6MCM>?<AUgJ8p=dOU>Da|DzSsE'
        '&KJ4c6RCzhn<5bxI8=VmUfN(eGveQN6XX-t&L5)P#q}adsOp|I!dPvZ6bybsJ*XY(5RsQjDl!PRoj^NIsJeL+2}OsX<Se~IjU8s4'
        'oMychT`xlC$}4s$Writ&X%JH+vv@=Vj2KIV=V61XT^w0v5_bDc*##c(1&w<Vvs|%=8WzKWy+C%{GLl>>LqrVgc7bSFsEDB=VI-$G'
        'bz60>M1(l;CK9vLbf-tyiP9a+&81`FL@w~}GY+%j_EtL<6d`t<DAq!Zm~TiC)K2x8i#{41%Z|M`-ckO7ogXmRzw0miZnj|DZY~l|'
        'HI}9vNstw75ivO6t9;GQ_t5rlkPOw1&GrAvRXw>an7!JAO^hT;O4Ey|ab=M>uj+h@zvgfFTmFu}=O0`-{5D_i&780B`~3~+uSS!`'
        'vB+9~?GI`n;FXm3)eubMfS(52yn(-G80Pt4>i%!QSDE!I1poj'
    )
