...
#
# Source file:
# /home/pi/ws/types/public_regulated_data_types/uavcan/si/unit/volumetric_flow_rate/Scalar.1.0.dsdl
#
# Generated at:  2025-12-19 12:32:01.137452 UTC
# Is deprecated: no
# Fixed port ID: None
...
class Scalar_1_0:
    ...
    _MODEL_: _pydsdl_.StructureType = _restore_constant_(
        'ABzY8!9_)B0{@j$%}*3D6kl`~5L6@(Ja~|kt{z74^R5Y(72Jq=Gfg`!+a{gqq#whs35gseVwz~e^Y6vi*~LYagOkj(o!9sA`@P@$'
        '-2Pd&Tg?;iRwM4X&WICMQLR2vrbR|_Q&h$&FCgC7^)}=_Sn+OD2{?fVhj0Mh*dZk?(Ec#cI;UmkR2E9*v)brT2yazR_O#h2mU@xx'
        '=2TM)ah}w|I%P_btvL5#vOj^|Os{nWhY%MD_2|oj7Y;tcW%d2O1hKQFgyz$_76_-F5}%5_%)PRzP+rw|<Jy)s)c*->kuc?n7UjT8'
        '=&fVOoH|bm!v)CIxYj>&Pj1;Ov~4F7!f1Vgw-8r}^R(pD^7DbdVw{2wkfXp;;yp`qkMJGRvNhRbjBm@W^Uvw&X{$GLgkb}dow$|<'
        'hRh<t!jcMKCvsDAh;7164zY#TXk0nRB4ML(rw%~glgkd#aZy>3V_!HN$D3qN4FxBav7RUnJ8_vf6KpQfparQY)*k25q7}os`zVZI'
        'Km9#Hu4W!#ZfTMdu2c#?`-rEL*vIuw6`00ytr!HI@=be#*4eRg(8r-;JE;e``<H$oE{zqGZDt!;>L~a`^a_#GVTD$dKDD@3xqxGN'
        'Uv}fI2J~3SC7P3(y8o4Ob|P94Z#N_mZ-_O<H-TM6F_qlt%1!xLK9Nu5Gx=P;XsT)xrV-w~Gwn?^fHnGyXNcEdD*w7U@8WTy!g!UK'
        '3gY@@LENZd2DwENwnbr3*-1ZdP!iM|JJs?m$)&>iko~ySr<|*D@Yf~zK3R8yM!2JkR*X<n9Rz%bZg2gEV>rasI1u#a14FolD$|(Y'
        'h7QwaE{zH{Jb5n=F|26W%=u1Wjs=$e0){ZfjDZ9I00'
    )
