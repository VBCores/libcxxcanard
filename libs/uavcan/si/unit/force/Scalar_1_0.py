...
#
# Source file:
# /home/pi/ws/types/public_regulated_data_types/uavcan/si/unit/force/Scalar.1.0.dsdl
#
# Generated at:  2025-12-19 12:32:01.084627 UTC
# Is deprecated: no
# Fixed port ID: None
...
class Scalar_1_0:
    ...
    _MODEL_: _pydsdl_.StructureType = _restore_constant_(
        'ABzY8!9_)B0{?weO>Yx15KSOSOAC~$6&!k?rxGqp%cr=4)JtfIC~!lTckRZOylcxJX@XRV9;hg?1X73JTgID|l%leSU3+KddEUI|'
        'FRfoMTaEgO_sy6&rZVEVl~l>kG*>($g)WVD(sPKn_Ph;+50<|l8xE)N@CXi}8{4F!CC1kR9Tv38oXkQceYUS{!Lz-BDrzCllOeZG'
        '>Iy_7&V8J&PodZBHICs3;v%8mTbT#X9ejeT8v2t2vAr$1VzWjT2&0}7pSruM+*nykFNc_MV_RwJ|K_qta_NcU)xZnrts`VXohPMc'
        '9K>q8+dnT)W!Y<t?W7RWXncit5Lb!wv|`k<i$LEHr=$ZMN?_^WeM<|E^c{|6d%8x9@5_yg&)L~oqt`q}*pQ2M>{R@~V_s|#rVEG-'
        '{7vJ^g{hHzJdxrM#D-XQ$cAxac|kpAa1w8meL3Qc7;Qa~40hu(aXO$%7*L!TioM3U^ieX$KKrQrsGt6x;%u6a@NA)z)Ypu}*8%q5'
        'PSeKknhCj*1+jb(R61{_1x7m)YhaDT!d9{emevM=xHPdywv}yWNiy(hk}E_|hb>uN`J~}cV(y7}AiD8R&2nPR3d6}R-T$A_nc9%Y'
        'do@ksHL+Uz8p#=oIbyRbw!~xcL_8JG#B=eYZlgtVg#<Rv-854boAQ_U5O2Pc{!P8#!|l{p@jB54;`&t}Zd~RXr-!U}c&X8=$q{c2'
        'x72Gpb7zMXLZahEKQ8qtW3n3jlO#T*=x$I*cYHaD2t%p@hab@Gt^ag6UQ06pg5G?{k!~rgWPDuEQCiF;^P{AxdV%nfp;dizcSG*-'
        'kY~REjaq~tL<9f;'
    )
