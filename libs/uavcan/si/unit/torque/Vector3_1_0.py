...
#
# Source file:
# /home/pi/ws/types/public_regulated_data_types/uavcan/si/unit/torque/Vector3.1.0.dsdl
#
# Generated at:  2025-12-19 12:32:01.096487 UTC
# Is deprecated: no
# Fixed port ID: None
...
class Vector3_1_0:
    ...
    _MODEL_: _pydsdl_.StructureType = _restore_constant_(
        'ABzY8!9_)B0{?|n-A@xi5O1NSAfO;d6OEB4Qy)Ar7>$o=tceHMfZ}(Sy}O~i@$UBA-7BpLi9ATeY$6Hk-&<#U#RA%RNqciU-!s48'
        'ey#lKRZ9KG+{n6-ieir_ketT+3k_oMNGOs_D6YYp*$pl8Q0Ed}b~CU?_ST-=wRKY^DNRs+J*VxErk>(no^tJJAwTEfZ9<6BvNe;W'
        '4N`HDT2?Z(&4GMm{jy)$w|mx16RNf3L9RjBk9Jf^e~hfDHaNu5u#|HoqM8!z>ND3yxJya9)?8}v4n!-EwlsU>j!ri<OCW{>QauPZ'
        'qLxhZglpbLi>XE|s6HKKngm>vxSz!Oi&$Ssl_rUZz_P36a`V{Txp_}ex9U_llhQZ4jztosX&O-(oecCH<0Q0&GtMKIcw5p?<17`<'
        'xG|71#*g{Z$*0%rmHhHPhRp*rg@t4^<hpD9aZ@2djLtWYdmQG%cJ<kBYi1sET}*BRKL_2KaUwEn7Dok9-6Rk(53N~Pg+$;4U7as7'
        'kQDJToY@2k8ONovd*<RgWT5%K?Z(I_terhXy9;Z198=jnYlN}dG|s{Pv~_>+PzBg|g(N(+{+1JH#|bsJk36R6;Fq0c=}_T>p_9?H'
        '57D(eaIUOsW>VPEA|(lEkQPHk0{bc9M5$RgfnE}H3sUS_=CgT)K!_ld5K;}1Juv6VwnHDugw%vbcFoKaC2|=8Dq<iR#WkCnd&NA!'
        '6*rNCou)fI!q&@oFgFv9bYmIEza89O)d5vG*yjO`nMi11Q<!ha3Diy$Bt;*Ejul5#JS?bc&D?;j-d%6Wb8EEP!Ek{vs<0^O_<#gx'
        '^APL-TVbnauHR>IO{A!H#I64)OYQhd0CT0^D$#;SA#^{MLR=y{Ue(zqd(Gakx9lBz&px<9*lo7dUo2Z@_X`*l`)|@H;%VzIkf8Pf'
        '-aA>Lw*Dk;@u|PX8u)vLVV)0G>-`4ppPHu%1poj'
    )
