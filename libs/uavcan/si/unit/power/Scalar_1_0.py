...
#
# Source file:
# /home/pi/ws/types/public_regulated_data_types/uavcan/si/unit/power/Scalar.1.0.dsdl
#
# Generated at:  2025-12-19 12:32:01.117577 UTC
# Is deprecated: no
# Fixed port ID: None
...
class Scalar_1_0:
    ...
    _MODEL_: _pydsdl_.StructureType = _restore_constant_(
        'ABzY8!9_)B0{?we&rcLF6drUJ5L6@(J#df{u9p$~#a$CFE4UH$W}0?dwoPWHO@A!ACM0r@h-sn;&%YO6XBQVS*uzZQ*Z1}N-uwEc'
        '^=rG8H6uPWBkp*a6DO>qrTR=+DRNTi%4ny&fOu!$+fevm#ru&Fa0ZW$;RrghO=?<Ud@ayHLF?S9Jk-kPMjr~B?-#VB7UDb^2<w!t'
        'L1uC8<79pY-I;E70>=;+3H9D87QArq39cjb=Mcp9juIuG5?LUedP;m^cU`)%s#0DJ@Wid1Qd9r8mPNvpC#9(SUP5;rAq(m}sWcZL'
        'SL6NOMS4ohUt?@Hg-}NJ72ZKyCC<~DQ_C*{eM6jz_OU2|r;86PEj-G1SeBj195KExXP3wM`FYlzIYHRKWIMJFQ98sH;ktmB;U<kM'
        'mug1XXxxY+kQ;K@p%yNT6$SNz!)d%r4%AR^Vzl){aoCH?#OYuQfq_yGLy>8mOTSVvWZA>M4|{3%3@bD91n-tQHTs58_&G%O?Nn?0'
        'ubIF~RS+xsp-lHpJAu*Ju`w{mVPY$p15+D&KwKIdB;U$6^VBf#sg5f|QiqhRsD0|-KotT`<s;dN_ZpRBW7Zf>X6gL@j@gL`MSRf6'
        'BwiD%wQrD|p@=OvJ90}tmCxjJ`9i*w+YOBtVI>OKxbV`nr%1|QT|>P6O8Ga<dLNe)SH+t|8;I-Ifw)n{G*%B)?}|#JQ<ERw8eyr|'
        'cIwSpQb>h<m%X^uqnxX{|IZ=$Aw~B>iE>9*qlhq|Wf1TKI^Ff3j^U#;V<70x2ZnMhRVUlygbveWE?FO2nz9#&7#dnP?{+UR#{$cL'
        '1OM|q@InLt00'
    )
